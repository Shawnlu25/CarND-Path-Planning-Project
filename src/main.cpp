...
int main() {
  ...
  VehicleFSM vehicle_fsm = VehicleFSM(49.5, 10.0, 2);
  cout << vehicle_fsm.is_state_initialized() << endl;
    ...
    if (length && length > 2 && data[0] == '4' && data[1] == '2') {
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          // Next Way Points Generation
          cout << "Start generating waypoint" << endl;
          ...
          for (int i = 1; i <= 50 - previous_path_x.size(); i++) {
            cout << i <<  50 - previous_path_x.size() << endl;
